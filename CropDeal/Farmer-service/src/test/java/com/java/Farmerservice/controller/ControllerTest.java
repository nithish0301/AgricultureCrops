package com.java.Farmerservice.controller;
import com.java.Farmerservice.service.FarmerService;
import com.java.Farmerservice.model.Farmer;
import com.java.Farmerservice.classes.Product;
...
class ControllerTest {
	...
	void getFarmerdetails()
	{
		mockProduct = new ArrayList<Product>();
		 ...
		 mockProduct.add(new Product("001","Apple","Fruit",120.0f,"Raipur","001"));
		 mockProduct.add(new Product("002","Orange","Fruit",80.0f,"Nagpur","001"));
	...
	void getFarmerproduct()
	{
		mockProduct = new ArrayList<Product>();
		 ...
		 when(farmerservice.getFarmerdetails(farmeremail)).thenReturn(farmer);
		 when(resttemplate.getForObject("http://crop-service/crop/farmer/"+farmer.getFarmerEmail(), List.class)).thenReturn(mockProduct);
